                ...
                <div class="card">
                    <form name="form1" action="" method="post">
                        <div class="card-body">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header"><strong>Add Assessment Categories</strong></div>
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="assessment_name" class="form-control-label">New Assessment Category</label>
                                            <input type="text" name="assessmentname" placeholder="Add Assessment Category" class="form-control">
                                        </div>
