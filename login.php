                    ...
                    <div class="panel-body">
                        <form action="" name="form1" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="username" title="Please enter your username" required=""
                            ...
                            <a class="btn btn-default btn-block" href="register.php">Don't have an account?</a>
